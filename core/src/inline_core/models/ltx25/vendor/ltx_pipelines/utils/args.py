...
from inline_core.models.ltx25.vendor.ltx_pipelines.utils.types import AutoDuration, OffloadMode
...
def add_hdr_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    from inline_core.models.ltx25.vendor.ltx_pipelines.utils.media_io.color_config import HDRColorSpace  # noqa: PLC0415
...
def _resolve_model_paths(namespace: argparse.Namespace) -> None:
    ...
    from inline_core.models.ltx25.vendor.ltx_pipelines.utils.model_paths import model_paths_from_namespace  # noqa: PLC0415
...
def _verify_sequence_path(flag: str, path: str) -> None:
    ...
    from inline_core.models.ltx25.vendor.ltx_pipelines.utils.media_io import is_exr_dir  # noqa: PLC0415
