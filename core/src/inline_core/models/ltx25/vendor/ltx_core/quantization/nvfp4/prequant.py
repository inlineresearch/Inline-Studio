...
from inline_core.models.ltx25.vendor.ltx_core.quantization.nvfp4.types import ActScale
...
def get_prequant_swap_module_ops(
    ...
    *,
    ...
    from inline_core.models.ltx25.vendor.ltx_core.quantization.nvfp4.linear import NVFP4Linear  # noqa: PLC0415
