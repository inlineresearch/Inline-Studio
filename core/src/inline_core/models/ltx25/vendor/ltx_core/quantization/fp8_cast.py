...
from inline_core.models.ltx25.vendor.ltx_core.loader.kernels import TRITON_AVAILABLE
...
from inline_core.models.ltx25.vendor.ltx_core.model.transformer.model import LTXModel
from inline_core.models.ltx25.vendor.ltx_core.quantization.policy import QuantizationPolicy
...
def fused_add_round_launch(target_weight: torch.Tensor, original_weight: torch.Tensor, seed: int) -> torch.Tensor:
    ...
    from inline_core.models.ltx25.vendor.ltx_core.loader.kernels import fused_add_round_kernel  # noqa: PLC0415
