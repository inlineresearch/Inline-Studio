...
def configure_natten_backend(module_root: nn.Module, backend: str | None) -> None:
    ...
    auto-selection.
    """
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.attention import (  # noqa: PLC0415
        NattenAttention,
...
def compile_diffusion_decoder(
    ...
    *,
    ...
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.chunked.block import ChunkedDiffusionNABlock  # noqa: PLC0415
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.combined.block import CombinedDiffusionNABlock  # noqa: PLC0415
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.dsl_kernels.block import DSLDiffusionNABlock  # noqa: PLC0415
