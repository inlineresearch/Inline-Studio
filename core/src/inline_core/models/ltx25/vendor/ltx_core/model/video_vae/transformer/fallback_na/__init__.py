...
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.fallback_na.eager import na3d as eager_na3d

if TYPE_CHECKING:
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.attention import NAAttentionCallable, NeighborhoodAttention3D
...
def na_attention_triton(
    ...
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.fallback_na.triton_na import (  # noqa: PLC0415
        na3d as triton_na3d,
    )
