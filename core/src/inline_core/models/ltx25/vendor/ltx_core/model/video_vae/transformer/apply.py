...
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.attention import (
    NeighborhoodAttention3D,
    configure_w_chunks,
    natten_available,
)
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.blocks import DiffusionNABlock
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.chunked.block import ChunkedDiffusionNABlock
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.combined.block import CombinedDiffusionNABlock
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.compiling import (
    compile_diffusion_decoder,
    configure_natten_backend,
)
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.config import (
    DiffVAEBlockKind,
    DiffVAEConfig,
    DiffVAEMode,
    NAttentionKind,
)
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.dsl_kernels.block import DSLDiffusionNABlock
from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.fallback_na import (
    EagerSdpaAttention,
    TritonNaAttention,
    triton_na_available,
    warn_no_natten,
...
if TYPE_CHECKING:
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.video_vae import DiffusionVideoDecoder
...
def _install_attention(decoder: DiffusionVideoDecoder, cfg: DiffVAEConfig) -> None:
    if cfg.attention is NAttentionKind.BLACKWELL_DSL:
        from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.transformer.dsl_kernels.apply_dsl import (  # noqa: PLC0415
...
def _diffusion_decoder_matcher(model: torch.nn.Module) -> bool:
    from inline_core.models.ltx25.vendor.ltx_core.model.video_vae.video_vae import DiffusionVideoDecoder  # noqa: PLC0415
