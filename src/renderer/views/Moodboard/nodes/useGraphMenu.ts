...
export function useGraphMenu(
  ...
  return useMemo(() => {
    // No "Save as character": one take is a single reference with no description, which is the
    // shape that trains a face nobody can summon. A character is built by the Character nodes.
